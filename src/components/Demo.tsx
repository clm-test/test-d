...
//         </button>
//         <button
//           onClick={() => sdk.actions.openMiniApp({url: "https://arb-counter.vercel.app"})}
//           disabled={
  ...
  return (
    <div className="min-h-screen w-full bg-yellow-50 flex flex-col items-center justify-center text-yellow-800 text-center px-6">
      ...
      <p className="text-base">
        ...
        <br />
        While you are here check out other miniapps
      </p>
      <div
        className="bg-[#8B5CF6] p-2 mt-3 text-base font-semibold cursor-pointer text-white flex items-center justify-center gap-2 rounded-lg"
        onClick={() =>
          sdk.actions.openMiniApp({ url: "https://arb-counter.vercel.app" })
        }
      >
        Open 2048
      </div>
      <div
        className="bg-[#8B5CF6] p-2 mt-3 text-base font-semibold cursor-pointer text-white flex items-center justify-center gap-2 rounded-lg"
        onClick={() =>
          sdk.actions.openMiniApp({ url: "https://fc-gif.vercel.app" })
        }
      >
        Open GIF
      </div>
